...
Функция СобратьДанныеЧековСчетмаш(Знач ДатаНачала, Знач ДатаОкончания, Знач СтруктураОтбора) Экспорт
    ...
    РасшифровкаОплатДляЧеков = ПолучитьРасшифровкуОплатДляЧековСчетмаш(ТаблицаОплатСДопДанными, СтруктураПараметров);
...
Функция ПолучитьТаблицуОплатСчетмаш(Знач ДатаНачала, Знач ДатаОкончания, Знач СтруктураОтбора) Экспорт
    ...
    Запрос.Текст =
        ...
        |ИМЕЮЩИЕ
        |   КОЛИЧЕСТВО(ВТ_ТаблицаРасшифровкиОплат.Ссылка) > 1
        |;";
...
Функция ПолучитьТекстЗапросаРасшифровкиОплатДляЧековСчетмаш(Знач Удалить_СтруктураПараметров)
    ТекстЗапроса =
        ...
        |	ТаблицаОбъектов.Контрагент КАК ГП_КонтрагентДокументаОплаты,
        ...
        |	ТаблицаОбъектов.Документ КАК Документ,
        |	ТаблицаОбъектов.Организация КАК Организация,
        |	ТаблицаОбъектов.ГП_КонтрагентДокументаОплаты КАК ГП_КонтрагентДокументаОплаты,
        |	ТаблицаОбъектов.ЛицевойСчет КАК ЛицевойСчет,
        ...
        |	втТаблицаРасшифровка.ГП_КонтрагентДокументаОплаты КАК ГП_КонтрагентДокументаОплаты,
        ...
        |	втТаблицаРасшифровка.ГП_КонтрагентДокументаОплаты,
    ...
    ТекстЗапроса = ТекстЗапроса + "
        ...
        |	втДанныеПоВидамОплатБезТарифа.ГП_КонтрагентДокументаОплаты КАК ГП_КонтрагентДокументаОплаты,
    ...
    ТекстЗапроса = ТекстЗапроса + "
        ...
        |	втДанныеПоВидамОплат.ГП_КонтрагентДокументаОплаты КАК ГП_КонтрагентДокументаОплаты,
        ...
        |	втДанныеПоВидамОплат.ГП_КонтрагентДокументаОплаты,
    ...
    ТекстЗапроса = ТекстЗапроса + "
        ...
        |	врРасшифровкаОплатДляЧеков.ГП_КонтрагентДокументаОплаты КАК ГП_КонтрагентДокументаОплаты,
