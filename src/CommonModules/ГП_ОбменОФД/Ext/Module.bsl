...
Функция ПолучитьТекстЗапросаОбщейТаблицыРасшифровкиОплатДляОФД()
    ТекстЗапроса =
        ...
        |	РегистрацияОплатыРасшифровкаПлатежа.АвансСумма КАК АвансСумма,
        |	РегистрацияОплатыРасшифровкаПлатежа.ДолгСумма КАК ДолгСумма,
        |	ВЫБОР
        ...
        |ГДЕ
        |	РегистрацияОплатыРасшифровкаПлатежа.Ссылка.Дата МЕЖДУ &НачалоПериода И &КонецПериода
