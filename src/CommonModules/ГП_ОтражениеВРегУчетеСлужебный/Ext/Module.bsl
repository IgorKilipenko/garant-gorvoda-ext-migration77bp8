...
Функция ПолучитьТекстЗапросаДанныхПоказанийСчетчиков()
    ...
    РезультатФункции.ТекстЗапроса =
        ...
        |////////////////////////////////////////////////////////////////////////////////
        |ВЫБРАТЬ РАЗРЕШЕННЫЕ
        |	ВТ_ПоказанияСчетчиковВсеЗаписи.Период КАК ПериодТекущегоПоакзания,
        ...
        |////////////////////////////////////////////////////////////////////////////////
        |ВЫБРАТЬ РАЗРЕШЕННЫЕ
        |	ВТ_ПоказанияСчетчиковПодготовка.ПериодТекущегоПоакзания КАК ПериодТекущегоПоакзания,
        ...
        |			И ВТ_ПоказанияСчетчиковПодготовка.ПериодТекущегоПоакзания < Т.ПериодТекущегоПоакзания
        |ГДЕ
        |	Т.ПериодТекущегоПоакзания ЕСТЬ NULL
        |;
        |
        |////////////////////////////////////////////////////////////////////////////////
        |ВЫБРАТЬ РАЗРЕШЕННЫЕ
        |	ВТ_РезультатПодготовка.ПериодТекущегоПоакзания КАК ПериодТекущегоПоакзания,
