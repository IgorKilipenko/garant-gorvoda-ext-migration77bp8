...
Функция ПолучитьТекстЗапросаДанныхПоказанийСчетчиков()
    ...
    РезультатФункции.ТекстЗапроса =
        ...
        |	ВЫБОР
        |		КОГДА ВТ_ПоказанияСчетчиковПодготовка.ВидПоказания = ЗНАЧЕНИЕ(Перечисление.КВП_ВидыТарифов.Ночной)
        |			ТОГДА ВТ_ПоказанияСчетчиковПодготовка.НочноеПоказание - ВТ_ПоказанияСчетчиковПодготовка.Расход
        |		ИНАЧЕ ВТ_ПоказанияСчетчиковПодготовка.ДневноеПоказание - ВТ_ПоказанияСчетчиковПодготовка.Расход
