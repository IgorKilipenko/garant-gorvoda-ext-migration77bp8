...
//              договоров используются установленные связи договоров в регистре `ГП_ДоговорыБП77`.
//              Если на момент создания договоров связи будут неактуальны функция отработает некорректно.
