...
// Выполняет создание документа назначения услуг для специальных (отдельных) л/с ОИ
// Возвращаемое значение:
//  - Структура:
//      * Успех - Булево
//      * СообщенияОбОшибках - Массив из Строка
//      * ТекстСообщения - Строка, Неопределено
//      * СозданныеДокументыУправленияУслугами - Массив из Документы.КВП_УправлениеУслугами - Фактически документ может быть только один!!!
Функция СоздатьДокументНазначенияУслугиХВСОИДляВиртуальныхСчетчиков(
    ...
    РезультатСоздания = ГП_МиграцияСчетчиковОИ.СоздатьДокументНазначенияУслугиХВСОИДляВиртуальныхСчетчиков(
            ДатаДокумента, ДатаНачалаДействияПоУмолчанию, ВыводитьСообщенияОбОшибках, Истина);

    Возврат РезультатСоздания;
КонецФункции

// Выполняет создание документов установки тарифа для специальных (отдельных) л/с ОИ
// Параметры:
//  ДатаДокумента - Дата
// Возвращаемое значение:
//  - Структура
...
Функция СоздатьДокументыУстановкиТарифовСчетчиковОИ(Знач ДатаДокумента) Экспорт
    РезультатСоздания = ГП_МиграцияСчетчиковОИ.СоздатьДокументыУстановкиТарифовСчетчиковОИ(ДатаДокумента, Истина);

    Возврат РезультатСоздания;
КонецФункции

// Создает документы Установка счетчиков специальных (отдельных) л/с ОИ
// Параметры:
//  ДатаДокумента - Дата, Неопределено
...
Функция СоздатьДокументыУстановкиВиртуальныхСчетчиковОИ(Знач ДатаДокумента = Неопределено, ДатаВключенияПоУмолчанию = Неопределено) Экспорт
    РезультатСоздания = ГП_МиграцияСчетчиковОИ.СоздатьДокументыУстановкиВиртуальныхСчетчиковОИ(
        ДатаДокумента, ДатаВключенияПоУмолчанию, Истина);
