...
// ->>> Гарант+ Килипенко 21.05.2025 [F00238020] Доработка отчета Списки абонентов с датой договора
#Область ВидыУслуг

// Возвращаемое значение:
//  - Структура
//      * Ссылка - СправочникСсылка.КВП_ВидыУслуг
//      * Код - Строка
//      * Наименование - Строка
Функция ПолучитьВидУслугиХолодноеВодоснабжение() Экспорт
    Возврат ПолучитьВидУслугиПоКоду("00-000001", Ложь);
КонецФункции
...
//      * Код - Строка
//      * Наименование - Строка
Функция ПолучитьВидУслугиГорячееВодоснабжение() Экспорт
    Возврат ПолучитьВидУслугиПоКоду("00-000003", Ложь);
КонецФункции
...
//      * Код - Строка
//      * Наименование - Строка
Функция ПолучитьВидУслугиВодоотведение() Экспорт
    Возврат ПолучитьВидУслугиПоКоду("00-000004", Ложь);
КонецФункции
...
//      * Код - Строка
//      * Наименование - Строка
Функция ПолучитьВидУслугиНегативногоВоздействияНаЦСВ() Экспорт
    Возврат ПолучитьВидУслугиПоКоду("00-000006", Ложь);
КонецФункции
...
//      * Код - Строка
//      * Наименование - Строка
Функция ПолучитьВидУслугиПоКоду(Знач Код, Знач ИгнорироватьПомеченныеНаУдаление = Истина) Экспорт
    Возврат ГП_ОбщегоНазначения.ПолучитьЭлементСправочникаПоКоду("КВП_ВидыУслуг", Код, ИгнорироватьПомеченныеНаУдаление);
КонецФункции

#КонецОбласти // ВидыУслуг
// <<<- Гарант+ Килипенко 21.05.2025 [F00238020] Доработка отчета Списки абонентов с датой договора
