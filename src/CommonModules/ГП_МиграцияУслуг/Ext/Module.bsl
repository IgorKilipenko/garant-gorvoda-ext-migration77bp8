...
Функция ВыполнитьЗаменуУслугиОснованияХВСЗависимойУслуг(
    ...
    Попытка
        Для Каждого СтрокаДанных Из ДанныеЗаполнения Цикл
            ...
            НоваяСтрокаЗависимости = НовыйНаборЗаписей.Добавить();
            ЗаполнитьЗначенияСвойств(НоваяСтрокаЗависимости, СтрокаДанных);
            НоваяСтрокаЗависимости.УслугаОснование = СтрокаДанных.УслугаОснованиеЗамены;

            НовыйНаборЗаписей.Записать();
            РезультатФункции.КоличествоИзмененныхСтрок = КоличествоИзмененныхСтрок + 1;
        КонецЦикла;
