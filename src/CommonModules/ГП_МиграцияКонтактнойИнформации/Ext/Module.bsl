...
// Устарела. Будет удалена или переработана в случае необходимости выполнения переноса адресов для отправки л/с
Функция Удалить_ПолучитьКонтактнуюИнформациюПоПредставлению(Представление, ОжидаемыйВид) Экспорт
    Возврат УправлениеКонтактнойИнформацией.КонтактнаяИнформацияПоПредставлению(Представление, ОжидаемыйВид);
КонецФункции

// Устарела. Будет удалена или переработана в случае необходимости выполнения переноса адресов для отправки л/с
Функция Удалить_ЗаполнитьАдресаДоставкиСчетовИКвитанцийЛицевыхСчетов()
...
// Устарела. Будет удалена или переработана в случае необходимости выполнения переноса адресов для отправки л/с
Функция Удалить_СформироватьАдресДоставкиСчетовИКвитанцийЛицевогоСчет(Знач СтруктураАдресаБП77, Знач АдресКонтрагента = Неопределено)
...
#КонецОбласти // УстаревшийФункционал
...
Функция ПолучитьТекстЗапросаЛицевыхСчетовДляУстановкиАдресаДоставкиСчетовИКвитанций() Экспорт
    РезультатФункции =
        ...
        |	// И ЛицевыеСчета.ЛицевойСчет.Идентификатор ПОДОБНО ""%00005623"" // Только для отладки
        |;
        |
        |////////////////////////////////////////////////////////////////////////////////
        |ВЫБРАТЬ РАЗРЕШЕННЫЕ
