...
// Возвращаемое значение:
//  - Строка
Функция Удалить_ПолучитьИмяФайлаТокенаПоУмолчанию(Знач Тестовый) Экспорт
...
// Возвращаемое значение:
//  - Строка
Функция Удалить_ПолучитьИмяФайлаДатыТокенаПоУмолчанию(Знач Тестовый) Экспорт
...
// Возвращаемое значение:
//  - Строка
Функция Удалить_ПолучитьИмяКаталогаВременныхФайловПоУмолчанию() Экспорт
    Возврат "\";
КонецФункции
...
Функция ЗаписатьДанныеВБезопасноеХранилище(Знач СтруктураДанныхБезопасногоХраненияДанных) Экспорт
    ...
    СтруктураДанныхБезопасногоХраненияДанных.Владелец = ПолучитьКлючВладельцаХранилищаДанных(
            СтруктураДанныхБезопасногоХраненияДанных.БазовыйВладелец, СтруктураДанныхБезопасногоХраненияДанных.БазовыйВладелец);
...
Функция ПрочитатьДанныеИзБезопасногоХранилища(Знач СтруктураДанныхБезопасногоХраненияДанных) Экспорт
    ...
    СтруктураДанныхБезопасногоХраненияДанных = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(СтруктураДанныхБезопасногоХраненияДанных);
    СтруктураДанныхБезопасногоХраненияДанных.Владелец = ПолучитьКлючВладельцаХранилищаДанных(
            СтруктураДанныхБезопасногоХраненияДанных.БазовыйВладелец, СтруктураДанныхБезопасногоХраненияДанных.Логин);
