...
Функция ЗаполнитьДинамическиеПоказателиЛицевыхСчетовСПустымВодозабором(Знач ДатаАктуальности = Неопределено) Экспорт
    ...
    ДанныеЗаполнения = ПолучитьЛицевыеСчетаБезНазначенногоВодозабора(ДатаАктуальности, Истина);
...
Функция ПолучитьЛицевыеСчетаБезНазначенногоВодозабора(
        Знач ДатаАктуальности = Неопределено, ТолькоИмеющиеСчетчикТолькоДляКанализации = Ложь) Экспорт
