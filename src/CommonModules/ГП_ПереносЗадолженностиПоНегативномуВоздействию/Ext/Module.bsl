...
Функция ЗаполнитьДокументКорректировкиДолгаПоКонтрагенту(ДокументОбъект, Знач МассивВидовДоговоров = Неопределено) Экспорт
    ...
    Если РезультатЗаполнения.Успешно = Ложь Тогда
        ОбщегоНазначения.СообщитьПользователю("Ошибка подбора данных о задолженности");
        Возврат Ложь;
    КонецЕсли;
...
//  ДокументОбъект - ДокументОбъект.КорректировкаДолга
//  Контрагент - СправочникСсылка.Контрагенты
Функция СоздатьИЗаполнитьДокументКорректировкиДолгаПоКонтрагенту(Знач Контрагент) Экспорт
    ДокументОбъект = НовыйДокументКорректировкиДолга(Контрагент);
    ДокументОбъект.Дата = ТекущаяДатаСеанса();
    ЗаполнитьДокументКорректировкиДолгаПоКонтрагенту(ДокументОбъект, ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(
