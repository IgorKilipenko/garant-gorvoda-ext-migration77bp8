...
//  Период - Дата, Неопределено - Дата остатков
...
Функция ПолучитьДанныеПоВзаиморасчетамКонтрагентов(
        Знач СписокКонтрагентов, Знач Период = Неопределено, Знач Организация = Неопределено) Экспорт
...
Функция НовыйТаблицаРаспределенияОплат()
    ...
    //ТаблицаРаспределения.Колонки.Добавить("КоэффициентРаспределения", Новый ОписаниеТипов("Число"));
