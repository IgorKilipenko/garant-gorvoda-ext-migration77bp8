...
Функция УстановитьСоответствияЗданий(Знач РазрыватьСуществующиеСвязи = Истина) Экспорт
    ...
    Исключение
        ...
        СтруктураОшибки = ГП_МиграцияОбщегоНазначения.УдалитьЗаписатьОшибкуВЖурнал(
...
Функция ЗаписатьДанныеЗданийВРегистр(Знач ИсходныеДанныеЗданий, Знач СохранятьСвязи = Истина) Экспорт
    ...
    КлючиУсловийЗдания = "ТолькоДляКанализации,ЭтоНегативноеВоздействиеЦСВ,НеНачислять";
    КлючиЧиселЗдания = "ПроцентХВ,ПроцентГВ,КоличествоПроживающих";
