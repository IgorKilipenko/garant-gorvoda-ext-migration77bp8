...
//  ТаблицаЗданийБП77 - ТаблицаЗначений, Неопределено
...
//      * ТекстСообщения - Строка
Функция СоздатьЗданияПоДаннымЗаписейБП77(Знач ПараметрыСоздания = Неопределено, Знач ТаблицаЗданийБП77 = Неопределено) Экспорт
    ...
    // Создание зданий
    ТаблицаЗданийБП77 = ?(ТаблицаЗданийБП77 = Неопределено, ПолучитьЗданияБП77ДляСозданияОбъектов(), ТаблицаЗданийБП77);
    НачатьТранзакцию();
    Попытка
