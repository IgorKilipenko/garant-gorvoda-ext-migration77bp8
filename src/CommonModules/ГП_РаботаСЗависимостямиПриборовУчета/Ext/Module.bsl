...
Функция ПолучитьТекстЗапросаУстановкиЗависимостейПриборовУчетаКвадра()
    ТекстЗапроса =
        ...
        |////////////////////////////////////////////////////////////////////////////////
        |ВЫБРАТЬ РАЗРЕШЕННЫЕ
        |	ВТ_ВыходныеПриборыУчета.ЛицевойСчет КАК ЛицевойСчетВход,
        |	ВТ_ВыходныеПриборыУчета.Помещение КАК ПомещениеВход,
        |	ВТ_ВыходныеПриборыУчета.Здание КАК ЗданиеВход,
        |	ВТ_ВходныеПриборыУчета.ЛицевойСчет КАК ЛицевойСчетВыход,
        |	ВТ_ВходныеПриборыУчета.Помещение КАК ПомещениеВыход,
        |	ВТ_ВходныеПриборыУчета.Здание КАК ЗданиеВыход,
        |	ВТ_ВыходныеПриборыУчета.ПриборУчета КАК ПриборУчетаВход,
        |	ВТ_ВходныеПриборыУчета.ПриборУчета КАК ПриборУчетаВыход
        |ИЗ
