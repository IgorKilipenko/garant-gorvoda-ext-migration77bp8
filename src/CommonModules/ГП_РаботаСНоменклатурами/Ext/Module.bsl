...
// Возвращаемое значение:
//  - Массив из Структура
Функция ПолучитьМассивНоменклатурСПсевдонимами() Экспорт
    МассивНоменклатурСПсевдонимами = Новый Массив();
    ...
    МассивНоменклатурСПсевдонимами.Добавить(СтруктураНоменклатуры);

    Возврат МассивНоменклатурСПсевдонимами;
КонецФункции
...
Функция ЗаменитьНаименованиеНоменклатурыПсевдонимом(Знач ИсходнаяСтрокаЗамены, Знач Номенклатура) Экспорт
    ...
    ШаблонЗаменыНаименованияНоменклатуры = Неопределено;
    МассивНоменклатурСПсевдонимами = ПолучитьМассивНоменклатурСПсевдонимами();

    Для Каждого СтруктураНоменклатурыЗамены Из МассивНоменклатурСПсевдонимами Цикл
        Если Номенклатура = СтруктураНоменклатурыЗамены.Ссылка Тогда
