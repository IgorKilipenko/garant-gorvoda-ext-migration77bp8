...
Функция ПолучитьПриборыУчетаДоговораПоЛицевомуСчету(Знач ЛицевойСчет, Знач ТолькоДействующиеСчетчики = Неопределено, ТолькоДействующиеУслуги = Неопределено) Экспорт
