...
Функция ПолучитьСоответствиеПризнаковПредметаРасчетаСчетмаш() Экспорт
    ...
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиПредметаРасчета.Товар"), 1);
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиПредметаРасчета.ПодакцизныйТовар"), 2);
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиПредметаРасчета.Работа"), 3);
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиПредметаРасчета.Услуга"), 4);
    // ...
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиПредметаРасчета.Платеж"), 10);
...
Функция ПолучитьСоответствиеПризнаковСпособаРасчетаСчетмаш() Экспорт
    ...
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиСпособаРасчета.ПредоплатаПолная"), 1);
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиСпособаРасчета.ПредоплатаЧастичная"), 2);
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиСпособаРасчета.Аванс"), 3);
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиСпособаРасчета.ПередачаСПолнойОплатой"), 4);
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиСпособаРасчета.ПередачаСЧастичнойОплатой"), 5);
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиСпособаРасчета.ПередачаБезОплаты"), 6);
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.ПризнакиСпособаРасчета.ОплатаКредита"), 7);
...
Функция ПолучитьСоответствиеСтавокНДССчетмаш() Экспорт
    ...
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.СтавкиНДС.НДС20"), "vat20");
    РезультатФункции.Вставит(ПредопределенноеЗначение("Перечисление.СтавкиНДС.НДС20_120"), "vat120");
...
Функция НовыйТипыОперацииРегистрацииЧека() Экспорт
    ...
    РезультатФункции.Вставит("Приход", "sell");
    РезультатФункции.Вставит("ВозвратПрихода", "sell_refund");
    РезультатФункции.Вставит("Расход", "buy");
    РезультатФункции.Вставит("ВозвратРасхода", "buy_refund");
