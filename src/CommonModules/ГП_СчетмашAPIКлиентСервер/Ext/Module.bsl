...
Функция ПолучитьСоответствиеСтавокНДССчетмаш() Экспорт
    ...
    РезультатФункции.Вставить(ПредопределенноеЗначение("Перечисление.СтавкиНДС.БезНДС"), "none");

    РезультатФункции.Вставить(ПредопределенноеЗначение("Перечисление.СтавкиНДС.НДС0"), "vat0");
    ...
    РезультатФункции.Вставить(ПредопределенноеЗначение("Перечисление.СтавкиНДС.НДС10"), "vat10");
    РезультатФункции.Вставить(ПредопределенноеЗначение("Перечисление.СтавкиНДС.НДС10_110"), "vat110");

    РезультатФункции.Вставить(ПредопределенноеЗначение("Перечисление.СтавкиНДС.НДС18"), "vat18");
    РезультатФункции.Вставить(ПредопределенноеЗначение("Перечисление.СтавкиНДС.НДС18_118"), "vat118");
