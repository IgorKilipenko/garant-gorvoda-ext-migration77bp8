...
// Создает документы Установка счетчиков ОИ
// Параметры:
//  ДатаДокумента - Дата, Неопределено
//  ДатаВключенияПоУмолчанию - Дата, Неопределено
//  ДляСпециальныхЛицевыхСчетовОИ - Булево
// Возвращаемое значение:
//  - Структура:
//      * Успех - Булево
//      * УстановленныеСчетчики - Массив из СправочникСсылка.КВП_Счетчики
//      * ТекстСообщения - Строка, Неопределено
Функция СоздатьДокументыУстановкиВиртуальныхСчетчиковОИ(
    Знач ДатаДокумента = Неопределено, ДатаВключенияПоУмолчанию = Неопределено, Знач ДляСпециальныхЛицевыхСчетовОИ = Ложь) Экспорт
    ...
    ДанныеДляЗаполнения = ПолучитьДанныеУстановкиВиртуальныхСчетчиковОИ(ДляСпециальныхЛицевыхСчетовОИ);
...
// Параметры:
//  Период - Дата, Неопределено - ПО умолчанию 01.01.2024
//  ДляСпециальныхЛицевыхСчетовОИ - Булево
// Возвращаемое значение:
//  - Структура
//      * Успех - Булево
...
//      * ТекстСообщения - Строка, Неопределено
Функция ЗаполнитьЗависимостиКанализацииОтУслугОИ(Знач Период = Неопределено, Знач ДляСпециальныхЛицевыхСчетовОИ = Ложь) Экспорт
    РезультатФункции = Новый Структура("Успех, КоличествоЗаписейЗависимыхУслуг, ТекстСообщения", Истина, 0);

    ДанныеСчетчиковОИ = ПолучитьДанныеУстановкиВиртуальныхСчетчиковОИ(ДляСпециальныхЛицевыхСчетовОИ);
...
//      * ТекстСообщения - Строка, Неопределено
Функция СоздатьДокументыУстановкиТарифовСчетчиковОИ(Знач ДатаДокумента, Знач ДляСпециальныхЛицевыхСчетовОИ = Ложь) Экспорт
    РезультатФункции = Новый Структура("Успех, СозданныеДокументы, ТекстСообщения", Истина, Новый Массив);

    ДанныеЗаполнения = ПолучитьДанныеДляУстановкиТарифовСчетчиковОИ(ДляСпециальныхЛицевыхСчетовОИ);
...
// Возвращаемое значение:
//  - ТаблицаЗначений
Функция ПолучитьДанныеУстановкиВиртуальныхСчетчиковОИ(Знач ДляСпециальныхЛицевыхСчетовОИ = Ложь) Экспорт
    Запрос = Новый Запрос;
...
Функция ПолучитьДанныеНазначенияУслугиХВСОИВиртуальныхСчетчиковОИ(Знач ДляСпециальныхЛицевыхСчетовОИ = Ложь) Экспорт
    Возврат ПолучитьДанныеУстановкиВиртуальныхСчетчиковОИ(ДляСпециальныхЛицевыхСчетовОИ);
КонецФункции
...
Функция ПолучитьДанныеДляУстановкиТарифовСчетчиковОИ(Знач ДляСпециальныхЛицевыхСчетовОИ = Ложь) Экспорт
    ДанныеУстановкиСчетчиковОИ = ПолучитьДанныеУстановкиВиртуальныхСчетчиковОИ(ДляСпециальныхЛицевыхСчетовОИ);
