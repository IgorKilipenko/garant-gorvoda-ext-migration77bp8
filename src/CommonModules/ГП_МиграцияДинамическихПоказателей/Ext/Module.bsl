...
Функция ПолучитьТекстЗапросаДанныхДинамическихПоказателей()
    РезультатФункции =
        ...
        |	ЗНАЧЕНИЕ(Справочник.lc_СпособыФинансирования.ПустаяСсылка) КАК Финансирование,
        ...
        |	ЗНАЧЕНИЕ(Справочник.lc_ХарактеристикиОбъекта.ПустаяСсылка) КАК Характеристика
        |ИЗ
