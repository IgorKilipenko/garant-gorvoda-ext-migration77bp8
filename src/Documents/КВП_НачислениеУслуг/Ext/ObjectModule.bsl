    ...
    Если НЕ мЗависимыеУслугиПоСобственномуНормативу Тогда
        ...
        Для Каждого СтрокаЗависимойУслуги ИЗ ТаблицаЗависимыхУслуг Цикл
            ...
            Если СтрокаЗависимойУслуги.УслугаОснование = ГП_РаботаСУслугами.ПолучитьУслугуКанализации().Ссылка
                ...
                НовыйМассивЗависимызУслуг = ТаблицаЗависимыхУслуг.НайтиСтроки(Новый Структура(
                    "Услуга, Объект", СтрокаЗависимойУслуги.УслугаОснование, СтрокаЗависимойУслуги.Объект));
                
                СтрокиТаблицыПоказаний = Новый Массив;
                Для каждого ЭлементУслуги Из НовыйМассивЗависимызУслуг Цикл
        ...
        КонецЦикла;
        #Вставка // Гарант+
        //СтрокиТаблицыПоказаний = ТаблицаЗависимыхУслуг.НайтиСтроки(Новый Структура("УслугаОснование, Услуга", 
        //    ГП_РаботаСУслугами.ПолучитьУслугуКанализации().Ссылка, 
        //    ГП_РаботаСУслугами.ПолучитьУслугуНегативногоВоздействияНаЦСВ().Ссылка));
        //Если СтрокиТаблицыПоказаний.Количество() > 0 Тогда
        //    МассивДанныхПоУслугам = ТаблицаПоУслугам.НайтиСтроки(Новый Структура("УслугаОснование, Услуга");
        //КонецЕсли;
        #КонецВставки
