...
Функция ГП_ПолучитьЗакрепленныеСчетчики(СписокОбъектов, СписокСчетчиков)
    ...
    // Добавление признака настройки для игнорирования фильтра отключенных счетчиков на поверку
    //  Т.е. недействующие счетчики с причиной отключения - Поверка будут попадать в отбор
    ПараметрыПостроения.Вставить("ГП_ИгнорироватьОтключениеНаПоверку");
