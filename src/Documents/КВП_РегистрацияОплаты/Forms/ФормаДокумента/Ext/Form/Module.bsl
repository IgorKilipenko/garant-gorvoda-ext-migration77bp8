...
Процедура ГП_ОплатаОтПокупателяФизЛицаПриИзменении(Элемент)
    Если ЭтотОбъект.Объект.ГП_ОплатаОтПокупателяФизЛица Тогда
        ЭтотОбъект.Элементы.ГП_ОплатаОтПокупателяФизЛица.ЦветТекстаЗаголовка = ОбщегоНазначенияКлиентПовтИсп.ЦветСтиля("ЦветОсобогоТекста");
    Иначе
        ЭтотОбъект.Элементы.ГП_ОплатаОтПокупателяФизЛица.ЦветТекстаЗаголовка = ОбщегоНазначенияКлиентПовтИсп.ЦветСтиля("ЦветТекстаПоля")
    КонецЕсли;
КонецПроцедуры
