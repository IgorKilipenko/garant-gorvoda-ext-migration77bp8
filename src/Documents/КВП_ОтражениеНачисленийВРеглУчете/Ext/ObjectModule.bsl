...
// Гарант+ Килипенко 23.10.2024 [F00229783] Отражение начислений в разрезе л/с ++
//
&ИзменениеИКонтроль("ПолучитьТаблицуОтражениеНачислений")
Функция ГП_ПолучитьТаблицуОтражениеНачислений1()

    СтруктураПараметров = Новый Структура;
    СтруктураПараметров.Вставить("Ссылка",        Ссылка);
    СтруктураПараметров.Вставить("ВидОперации",   ВидОперации);
    СтруктураПараметров.Вставить("Взаиморасчеты", Взаиморасчеты);
    СтруктураПараметров.Вставить("Контрагент",    Контрагент);
    #Вставка // Гарант+ Килипенко 23.10.2024 [F00229783] Отражение начислений в разрезе л/с ++
    // СтруктураПараметров.Вставить("ГП_ЛицевойСчет",    Контрагент);
    // Движение.ГП_ЛицевойСчет         = СтрокаНачисления.ГП_ЛицевойСчет;
    #КонецВставки // Гарант+ Килипенко 23.10.2024 [F00229783] Отражение начислений в разрезе л/с --
    ...
    СтруктураПараметров.Вставить("ТипДокументаОтражения", ТипДокументаОтражения);
    СтруктураПараметров.Вставить("ФормироватьТиповыеДокументыСОтрицательнымиСуммами", ФормироватьТиповыеДокументыСОтрицательнымиСуммами);
    СтруктураПараметров.Вставить("ВыполнятьОтражениеНачисленийСОбъемамиИТарифами",    ВыполнятьОтражениеНачисленийСОбъемамиИТарифами);

    Возврат ТаблицаОтраженияНачисленийВРегламентированномУчете(ЭтотОбъект.Дата, Организация, СтруктураПараметров);

КонецФункции // Гарант+ Килипенко 23.10.2024 [F00229783] Отражение начислений в разрезе л/с --
