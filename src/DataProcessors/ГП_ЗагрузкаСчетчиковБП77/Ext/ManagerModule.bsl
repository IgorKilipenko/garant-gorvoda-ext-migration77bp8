...
Процедура ЗагрузитьДанныеСчетчиковВРегистр(ПараметрыВыгрузки, АдресХранилища) Экспорт
...
Функция УстановитьСоответствияУслугСЛицевымиСчетами(Знач ЗаписыватьПустые = Истина) Экспорт
    ...
    ТаблицаСоответствияУслуг = ГП_МиграцияПриборовУчета.ПолучитьЛицевыеСчетаУОбъектовАбонентовДляСопоставления();
