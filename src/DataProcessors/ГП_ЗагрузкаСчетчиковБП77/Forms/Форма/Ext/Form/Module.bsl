...
Процедура ВыполнитьОперациюЗагрузкиДанныхСчетчиков(Знач АдресФайла)
    ...
    Результат = ЗагрузитьДанныеСчетчиковВФонеНаСервере(АдресФайла, ЭтотОбъект.УникальныйИдентификатор);
...
// Выполняет обновление и создание счетчиков в ИБ из регистра
&НаКлиенте
Процедура ВыполнитьОперациюОбновленияСчетчиков()
    ЭтотОбъект.АдресХранилищаРезультатаОперации = "";
    ЭтотОбъект.ТекстСообщенияРезультатОперации = "";

    Результат = ОбновитьСчетчикиИзРегистраВФонеНаСервере(ЭтотОбъект.УникальныйИдентификатор);
...
&НаСервере
Функция ЗагрузитьДанныеСчетчиковВФонеНаСервере(Знач АдресФайла, Знач УникальныйИдентификатор)
...
&НаСервере
Функция ОбновитьСчетчикиИзРегистраВФонеНаСервере(Знач УникальныйИдентификатор)
