...
Процедура УстановитьДоступностьКомандДействий()
    ЭтотОбъект.Элементы.ЗагрузитьСчетчики.Доступность = ЭтотОбъект.ИнформацияОЗагруженныхФайлах.Количество() > 0;
    ЭтотОбъект.Элементы.ЗагрузитьПоказанияСчетчиков.Доступность = ЭтотОбъект.ИнформацияОЗагруженныхФайлах.Количество() > 0;
КонецПроцедуры
