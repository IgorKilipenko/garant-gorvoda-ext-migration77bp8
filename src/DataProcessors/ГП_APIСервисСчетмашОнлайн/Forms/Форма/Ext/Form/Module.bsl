...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
    ...
    Кон = ГП_РаботаСУслугами.ПолучитьУслугуКанализации().Ссылка;
    ГП_УслугаНВНаЦСВ = ГП_РаботаСУслугами.ПолучитьУслугуНегативногоВоздействияНаЦСВ().Ссылка;
    ГП_УслугаПотериВоды = ГП_РаботаСУслугами.ПолучитьУслугуПотериВоды().Ссылка;
    ГП_УслугаХВСОИ = ГП_РаботаСУслугами.ПолучитьУслугуПлатаЗаХолодноеВодоснабжениеОИ().Ссылка;
    ...
    Ан = ГП_РаботаСУслугами.ПолучитьУслугуПодогреваХолоднойВоды().Ссылка;
