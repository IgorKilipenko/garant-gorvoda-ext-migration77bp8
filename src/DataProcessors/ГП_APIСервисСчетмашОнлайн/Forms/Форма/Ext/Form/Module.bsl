...
Процедура Удалить_ПолучитьДанные1С7(Логин, Пароль, Путь, ИмяБазы, Подключение = Неопределено)
    ...
    // Сварачиваем таблицу
    Удалить_СвернутьВременуюТаблицу();
...
//
&НаСервере
Процедура Удалить_СвернутьВременуюТаблицу()
    // Гарант+ Килипенко ++
...
Процедура ПолучитьОбщуюТаблицуРасшифровкиОплат()
    // Гарант+ Килипенко 11.02.2025 Признак выгрузки в ОФД ++
    ТаблицуРасшифровкиОплатДляОФД = ГП_ОбменОФД.ПолучитьСвернутуюОбщуюТаблицуРасшифровкиОплатДляОФД(
    ...
    ЭтотОбъект.Объект.ОбщаяТаблицаРасшифровкиОплат.Загрузить(ТаблицуРасшифровкиОплатДляОФД);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
    ...
    // Гарант+ Килипенко --
    ЭтотОбъект.Подогрев = ГП_РаботаСУслугами.ПолучитьУслугуПодогреваХолоднойВоды().Ссылка;
    // Гарант+ Килипенко ++
