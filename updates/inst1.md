...
КонецЕсли;
```
??? Провести документы закрытия л/с
...
14. Заполнение установки счетчиков (примерно 10 мин)
	...
	14.1.2 Провести документ Ввод показаний счетчика (предварительно удалить строки с пустыми услугами, Установить дату документа 17.01.2025 23 59 59)
...
37. Провести документы закрытия л/с
