...
14. Заполнение установки счетчиков (примерно 10 мин)
	...
	14.1.2 Провести документ Ввод показаний счетчика (предварительно удалить строки с пустыми услугами)
...
27.3 Открытие л/с счетчиков ОИ
    ...
    27.3.1 Провести документы Открытия л/с
...
33. Замена пустых водозаборов в дин. показателей на НетВодозабора
    ...
    33.1 Обновление регистр дин. показателей л/с
...
35. Ввод начального сальдо взаиморасчетов (в2 из БП77)
    ...
    35.1 Заполнение регистра БП77 из файла ГП_ВзаиморасчетыПоАбонентам_БП77_на05.12.24.xml
        - заполнено:  3 674

    35.2 >>> скрипт: 14___ВВОД_НАЧАЛЬНОГО_САЛЬДО_В2_изБП77.xbsl
        - создано 3 документа
    
    35.3 Провести документы Ввода начального сальдо
